...
venue: "iDiv over yDiv"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "iDiv Leipzig, room Beehive (B.00.02), Puschstrasse 4, 04103 Leipzig"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "51.318096"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "12.395875"       # decimal longitude of the workshop venue (use https://www.latlong.net)
...
instructor: ["Oskar Hagen [OH]", "Alex Skeels [AS]", "Benjamin Rosenbaum [BR]", "Florian Hartig [FH]"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
invited lecturer: ["Florian Hartig [FH]"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["oskar@hagen.bio"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://drive.google.com/drive/folders/1xgiJD-V8YNCZZzAWskXnecZtpQoPNa9B?usp=sharing # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
{% if online == "false" %}
  ...
  Classroom and restrooms are wheelchair / scooter accessible.
{% else %}
